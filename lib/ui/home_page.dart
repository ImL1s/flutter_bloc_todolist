...
import 'package:flutter_bloc_learn/bloc/todo_bloc.dart';
          ...
          return new Padding(
            ...
            child: new Container(
              ...
              child: new Container(
                ...
                child: Padding(
                  padding: EdgeInsets.only(
                      left: 15, top: 10.0, right: 15, bottom: 30),
                  child: ListView(
                    children: <Widget>[
                      Row(
...
//                                labelText: 'Search *',
  ...
  Widget getTodosWidget() {
    return StreamBuilder<List<Todo>>(
      ...
      builder: (BuildContext context, AsyncSnapshot<List<Todo>> asyncSnapshot) {
        return getTodoCardWidget(asyncSnapshot);
      },
    );
  }
